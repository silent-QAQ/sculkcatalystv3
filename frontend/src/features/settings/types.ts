...
export const AGENT_KINDS: { key: string; label: string; commandHint: string }[] = [
  { key: 'codex', label: 'Codex CLI', commandHint: 'codex（参数填 acp，需已安装 Codex CLI）' },
  { key: 'claude-code', label: 'Claude Code CLI', commandHint: 'npx（参数填 @zed-industries/claude-code-acp）' },
